...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-wv++qhml7au#g*9#h&4#g^qppw1p&xh%z#h#i_p$kr+mh^@eb0')
...
# Support both PostgreSQL (Render) and MySQL (Railway/local)
    ...
    if DB_ENGINE == 'postgresql':
        ...
        DATABASES = {
            'default': {
                ...
                'PASSWORD': config('DB_PASSWORD', default='NewStrongP@ssword123!'),
                'HOST': config('DB_HOST', default='localhost'),
